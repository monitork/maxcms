<div class="content_table">
	<table cellspacing="0" cellpadding="0" border="0" width="100%">
		<tr>
			...
			<th width="100" onclick="sort('status')"><div id="status" class="sort icon_no_sort">Trạng thái</div></th>
			<th class="th_last" width="150" onclick="sort('created')"><div id="created" class="sort icon_sort_asc">Ngày tạo</div></th>
		</tr>
		<?php
			if($result){
				$i=0;
